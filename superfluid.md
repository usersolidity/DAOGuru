...
https://github.com/DAO-Guru/DAOGuru/tree/master/src/superfluid
...
export const updateFlow = async (provider, sender, recipient, flowRate) => {
  ...
  try {
    ...
    let  updateFlowReceipt = await updateFlowOperation.exec(signer);
...
export const deleteFlow = async (provider, sender, recipient) => {
  ...
  try {
    ...
    let deleteFlowReceipt = await deleteFlowOperation.exec(signer);
